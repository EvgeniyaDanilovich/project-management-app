...
export const Column: React.FC<ColumnProps> = ({ title, boardId, columnId }) => {
    ...
    return (
        <div className={styles.column}>
            {editMode ?
                <form className={styles.formUpdate} onSubmit={handleSubmit(handleUpdateColumn)}>
                    <input className={'input input__s'} type={'text'} {...register('title')} defaultValue={updatedColumnTitle} />
